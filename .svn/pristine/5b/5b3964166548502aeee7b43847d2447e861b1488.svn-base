...
export const equipmentBasicInfo = [
  { label: '设备编号', key: 'title' },
  { label: '原设备编号', key: 'title' },
  { label: '注册证号', key: 'title' },
  { label: '设备名称', key: 'title' },
  { label: '设备来源', key: 'title' },
  { label: '设备原值', key: 'title' },
  { label: '设备数量', key: 'title' },
  { label: '规格型号', key: 'title' },
  { label: '所属科室', key: 'title' },
  { label: '单位', key: 'title' },
  ...
  { label: '维保截止日期', key: 'title' },
  { label: '发票号', key: 'title' },
  { label: '财务编号', key: 'title' },
  { label: '启用日期', key: 'title' },
  { label: '启用状态', key: 'title' },
  { label: '存放地点', key: 'title' },
  { label: '折旧总额', key: 'title' },
  { label: '国别', key: 'title' },
  { label: '固资编码', key: 'title' },
