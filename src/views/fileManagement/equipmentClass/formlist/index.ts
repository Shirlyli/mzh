...
export const equipmentVO = [
  ...
  { label: '生产商', key: 'manufactorId', required: true },
...
export const equipmentPurchases = [
  { label: '到货截止日期', key: 'aogDeadlineTime', type: 'date', required: true },
  ...
  { label: '合同截至日期', key: 'contractDeadlineTime', type: 'date', required: true },
...
export const equipmentMaintain = [
  ...
  { label: '医院ID', key: 'companyInfoId', required: true },
  ...
  { label: '上次保养时间', key: 'lastMaintainTime', type: 'date', required: true },
...
export const equipmentInspection = [
  ...
  { label: '仓库id', key: 'departmentId', required: true },
  { label: '设备ID', key: 'equipmentId', required: true },
