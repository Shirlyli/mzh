...
export const equipmentResources = [
  { label: '使用说明书名称', key: 'instructionsName', required: true, type: 'upload' },
  { label: '使用说明书', key: 'instructionsUrl', required: true },
  { label: '保养说明书名称', key: 'maintainName', required: true, type: 'upload' },
